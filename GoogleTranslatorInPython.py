# -*- coding: utf-8 -*-
"""
Created on Thu Oct 10 18:15:24 2024
    ...
    try:
        ...
        if text_:
            ...
            for i,j in language.items():
                if(j==c3):
                    lan_=i
            Cwords=words.translate(from_lang=lan,to=str(lan_))
            text2.delete(1.0,END)
            text2.insert(END, Cwords)
...
text2=Text(f1, font="RobotV 20", bg="white", relief=GROOVE, wrap=WORD)
